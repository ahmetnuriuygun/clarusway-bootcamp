# Get the total number of seconds from the user. Write a program that returns the total seconds in hours, minutes and seconds. # For example: 4565436 seconds is 1268 hours, 10 minutes and 36 seconds.
